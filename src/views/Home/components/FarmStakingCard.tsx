...
const FarmedStakingCard = () => {
  ...
  const miaUserBalance = miaBalance.balance ? getBalanceNumber(miaBalance.balance) : 0
    ...
    const tokenAdded = await window.ethereum.request({
      ...
      params: {
        ...
        options: {
          ...
          image: `https://lokiswap.finance/images/token.png`,
        },
      },
    })
      ...
      <CardBody>
        ...
        <CardImage src="/logo.png" alt="cake logo" width={64} height={64} />
          <Button 
            ...
            onClick={() => registerToken('0x5417f8559ee78f0e77589109d605246c89dd01c9', 'LOKI', 18)}>
            +
